...
export const deploy = async (
  params: DockerDeployParams & { nginx_instance: string; domain: string, certbot_email: string }
) => {
  ...
  await addReverseProxyConfig(params.container_name, params.nginx_instance, params.domain, 8484, params.certbot_email);
};
